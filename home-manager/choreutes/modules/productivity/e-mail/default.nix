...
let
  cfg = config.host-specific.productivity.e-mail;
in
{
  options = with lib; {
    host-specific.productivity.e-mail.enable = mkOption {
      description = "Whether to enable configuration of e-mail accounts";
